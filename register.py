...
class Register:
    def __init__(self,root):
        ...
        title=Label(frame1,text="REGISTER HERE",font=("timmes new roman",20,"bold"),bg="white",fg="green").place(x=50,y=30)
        #--------------------------------------------ROW1------------------------------------------------------------------------------
        ...
        f_lname=Label(frame1,text="Last Name",font=("times new roman",15,"bold"),bg="white",fg="gray").place(x=370,y=100)
        self.txt_lfname=Entry(frame1,font=("times new roman",15),bg="lightgray")
        self.txt_lfname.place(x=370,y=130,width=250)
        ...
        self.cmb_quest['values']=("Select","Your First Pet Name","Your Birth Place","Your Best Frined Name")
        ...
        #=====terms=====
        self.var_chk=IntVar()
        chk=Checkbutton(frame1,text="I Agreee The Terms & Conditions",variable=self.var_chk,onvalue=1,offvalue=0,bg="white",font=("times new roman",12)).place(x=50,y=380)
    ...
    def register_data(self):
        #print(self.var_fname.get(),self.txt_lfname.get())
        if self.txt_fname.get()=="" or self.txt_contact.get()=="" or self.txt_email.get()=="" or self.cmb_quest.get()=="Select" or self.txt_answer.get()=="" or self.txt_password.get()=="" or self.txt_cpassword.get()=="":
             ...
             try:
               ...
               if row!=None:
                  ...
                  messagebox.showerror("Erroe",f"Erroe due to: {str(es)}",parent=self.root)
             #messagebox.showinfo("Success","Register Successfull",parent=self.root)
