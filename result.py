...
class resultClass:
    def __init__(self,root):
        ...
        lbl_marks_op=Label(self.root,text="Marks Obtained",font=("goudy old style",20),bg="white").place(x=50,y=280)
        lbl_full_marks=Label(self.root,text="Full Marks",font=("goudy old style",20),bg="white").place(x=50,y=340)
        ...
        btn_search=Button(self.root,text="Search",font=("goudy old style",15),bg="#03a9f4",fg="White",cursor="hand2",command=self.search).place(x=500,y=100,width=100,height=28)
        ...
        self.bg_img=self.bg_img.resize((500,300),Image.AFFINE)
