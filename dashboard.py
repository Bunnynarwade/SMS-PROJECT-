...
class RMS:
    def __init__(self,root):
        ...
        btn_view=Button(M_Frame,text="Students Results",font=("goudy old style",15,"bold"),bg="#0b5377",fg="White",cursor="hand2",command=self.add_report).place(x=680,y=5,width=200,height=40)
        ...
        #Footer
        footer=Label(self.root,text=" SMS-Student management System\nContact Us for any Technical Issue: 8928313075",font=("goudy old style",12,),bg="#262626",fg="white").pack(side=BOTTOM,fill=X)
        self.update_details()
        #=====Update Details=====
